...
var Command = &commands.YAGCommand{
	...
	Arguments: []*dcmd.ArgDef{
		{Name: "Team", Type: dcmd.String, Help: "Team name", AutocompleteFunc: sportsteams.NBAAutocomplete},
	},
	...
	RunFunc: func(data *dcmd.Data) (interface{}, error) {
		...
		addrTeam := "https://site.api.espn.com/apis/site/v2/sports/basketball/nba/teams/" + url.QueryEscape(query)
		...
		addrScore := "http://site.api.espn.com/apis/site/v2/sports/basketball/nba/scoreboard/" + eventID
...
func apiTeamSearch(addrTeam string) (*Output, error) {
	...
	if resp.StatusCode == 502 {
		return nil, commands.NewPublicError("HTTP err: ", resp.StatusCode, " You probably entered a team with a space in the name. Check this link for a Team ID: <https://docs.google.com/spreadsheets/d/1QXwnLD-OPOoDkoqNxx9iSI_Nc1WgbTVYQueyx6UPPWY/edit?usp=sharing> There is an additional tab for NBA Teams and College teams.")
	} else if resp.StatusCode == 400 {
		return nil, commands.NewPublicError("HTTP err: ", resp.StatusCode, " You have entered an invalid team. Please refer to this list to grab your Team ID: <https://docs.google.com/spreadsheets/d/1QXwnLD-OPOoDkoqNxx9iSI_Nc1WgbTVYQueyx6UPPWY/edit?usp=sharing> There is an additional tab for NBA Teams and College teams.")
